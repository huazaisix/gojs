<template>
 <div>
   <el-select class="onlySty" v-model="chooseData"  multiple placeholder="请选择" style="width: 300px" @change='selectAll'>
    ...
    <!-- <el-input style="margin-bottom: 1rem;" 
          v-model="oldChooseData.toString()" >
      </el-input> -->  
...
<style>
  .onlySty .el-input__suffix-inner{
    display:none;
  }
